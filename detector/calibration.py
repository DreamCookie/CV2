...
class PlaneCalibrator: #Заглушка калибровки плоскости стола, остается ручная калибровка пока что
    ...
    def image_to_plane(self, x: float, y: float):
        raise NotImplementedError("Калибровка недоступна...")


# Пока нет меток типа arUco - это не имеет смысла
